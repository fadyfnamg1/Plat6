...
// Converts an ISO 3166-1 alpha-2 code into its flag emoji (regional indicator pair).
...
// Alphabetical (by English name) — used to populate every country picker in the app.
export const COUNTRIES: Country[] = [
  ...
  { name: 'Dominica', code: 'DM' }, { name: 'Dominican Republic', code: 'DO' }, { name: 'DR Congo', code: 'CD' },
  ...
  { name: 'Ivory Coast', code: 'CI' }, { name: 'Jamaica', code: 'JM' }, { name: 'Japan', code: 'JP' },
  ...
  { name: 'Russia', code: 'RU' }, { name: 'Rwanda', code: 'RW' }, { name: 'Saint Lucia', code: 'LC' },
